...
async function getStatsAndProjections(leagueId_) {

    // init client to get data from ESPN api
    const myClient = new Client.Client({ leagueId: leagueId_ });
    ...
    await myClient.getFreeAgents({seasonId: 2022, scoringPeriodId: 0}).then(async function (response) {
...
// getStatsAndProjections(leagueId);

module.exports = getStatsAndProjections;
